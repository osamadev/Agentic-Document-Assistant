...
# Handle print_color import with fallback
try:
    from print_color import print
except ImportError:
    # Fallback to regular print if print_color is not available
    print("Note: print_color not available, using regular print")
    # Keep the regular print function
    pass
